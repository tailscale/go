...
func Properties() map[string]*RangeTable {
	propertiesOnce.Do(initProperties)
...
// FoldCategory returns a map from a category name to a table of
// code points outside the category that are equivalent under
// simple case folding to code points inside the category.
// If there is no entry for a category name, there are no such points.
func FoldCategory() map[string]*RangeTable {
	foldCategory.Do(initFoldCategory)
	return foldCategory.v
}

func initFoldCategory() {
...
// FoldScript returns a map from a script name to a table of
